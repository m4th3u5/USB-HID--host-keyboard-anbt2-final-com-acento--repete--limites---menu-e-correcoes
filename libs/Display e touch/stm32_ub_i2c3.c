...
//
// Nota: Possíveis Atribuições dos pinos
//            I2C3 : SCL :[PA8] 
//                   SDA :[PC9]
//            resistores pull-up externos sobre SCL+SDA necessário
//--------------------------------------------------------------
...
void UB_I2C3_Init(void)
{
  ...
  //inicialização pode ser feita apenas uma vez
  if(init_ok!=0) {
    return;
  } 
  ...
  // I2C Connectar função alternativa com os IO pins
  ...
  // I2C função alternativa OpenDrain
...
//--------------------------------------------------------------
// Lendo um endereço via I2C de um escravo
